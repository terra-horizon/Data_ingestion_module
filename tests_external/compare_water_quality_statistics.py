...
from providers.forecaster_original import (
    load_dotenv_file,
    water_quality_statistics_original,
)
from providers.ingestion_service import water_quality_statistics_via_ingestion_service
...
def main():
    ...
    original = water_quality_statistics_original(
        bbox,
        start_date,
        end_date,
        max_cloud_coverage,
    )
    via_ingestion = water_quality_statistics_via_ingestion_service(
        bbox,
        start_date,
        end_date,
        max_cloud_coverage,
    ...
    print()
    print("Water quality comparison:")
    print(json.dumps({
